# Followed guide because I didn't know how to do this on my own: https://www.geeksforgeeks.org/python/python-todo-gui-application-using-tkinter/
from tkinter import *
...
if __name__ == "__main__":
    ...
    TextArea = Text(gui, height = 10, width = 30)
